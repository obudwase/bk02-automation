...
function OppositionSheet({ prot, ant, onReset }) {
  ...
  const exportJSON = () => {
    const blob = new Blob([JSON.stringify({ protagonist:prot, antagonist:ant }, null, 2)], { type:"application/json" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a"); a.href=url; a.download="opposition-engine-sheet.json"; a.click();
  };
      ...
      <div style={{ maxWidth:"1100px", margin:"0 auto" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"32px" }}>
          ...
          <div style={{ display:"flex", gap:"10px" }}>
            <button onClick={exportJSON} style={sty.btn("gold")}>Export JSON →</button>
...
export default function App() {
  ...
  function handleSkip() {
    // Skip optional steps (Step XVI)
    setAntagonist(prev => ({ ...prev, [step.id]: null }));
    setOutput(null);
    setPhase("sheet");
  }
